...
(self.webpackChunksapataria_capacita_brasil_react =
  self.webpackChunksapataria_capacita_brasil_react || []).push([
  [453],
  {
    453: (e, t, n) => {
      (n.r(t),
      ...
      var i,
            ...
            v = function (e) {
              if (!e.hadRecentInput) {
                ...
                e.startTime - t.startTime < 5e3
                  ? ((r += e.value), o.push(e))
                  : ((r = e.value), (o = [e])),
                  r > a.value && ((a.value = r), (a.entries = o), n()));
              }
            },
            p = u("layout-shift", v);
          p &&
        ...
        L = function (e, t) {
          i ||
            ((i = t), (a = e), (r = new Date()), F(removeEventListener), S());
        },
        S = function () {
          if (a >= 0 && a < r - w) {
            var e = {
        ...
        P = function (e, t) {
          ...
          if (o) {
            ...
            var v = function () {
              k[a.id] ||
                (o.takeRecords().map(r), o.disconnect(), (k[a.id] = !0), n(!0));
            };
...
//# sourceMappingURL=453.7dd78835.chunk.js.map
